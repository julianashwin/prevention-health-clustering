...
AR(1) plus measurement error, plus one level shift per birth decade, common to the classes, on the one contract that carries all three
...
JOBS = [("health-h-ssm-cohort", "health-h-ssm-cohort"),
        ...
        ("health-fi10-ssm-cohort", "health-fi10-ssm-cohort")]
