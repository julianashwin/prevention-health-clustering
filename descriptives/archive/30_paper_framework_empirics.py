"""ARCHIVED 24 Sep 2026: none of its six figures is in the paper any more (the framework
section dropped them); kept for the numbers in artifacts/descriptives/paper_fw_*.csv.
