...
Stage 3 has now run: concentration reproduces, the age profile does not,
and the diagnosis is flat unit costs rather than the banded instrument. If
Stage 4 shows the convexity conclusion stable across the
